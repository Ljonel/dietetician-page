        ...
        <>
            <section id="cards-offer" ref={element}>
                {cards.map((card, index) => (
                    <motion.div animate={controls} variants={card.animate} key={index} whileHover={{ scale: 1.1 }} className="card" >
                        <div className="card-title">
                            <motion.div className="card-img" whileHover={{ scale: 1.2 }}> <motion.img src={card.img} alt="" /></motion.div>
