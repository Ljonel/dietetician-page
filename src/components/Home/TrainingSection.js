    ...
    <>
      <section id="training" ref={element}>
        <div className="training-text">
          ...
          >
            <IoBarbell className="training-icon" />
          </motion.div>
          <motion.h1
            animate={controls}
            variants={reveal}
          ...
          <motion.h5
            ...
            transition={{ delay: 0.1, type: "tween" }}
          >
            Jestem certyfikowanym Trenerem Personalnym. Od dziecka mocno
            związana ze sportem, w tym od sześciu lat trenuję siłowo. Swoją
        ...
        <div className="training-img">
          <div className="training-box"></div>
          <motion.div
            animate={controls}
            variants={box}
            transition={{ delay: 0.1, type: "tween" }}
