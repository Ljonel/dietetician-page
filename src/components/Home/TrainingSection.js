                ...
                <div className="training-text">
                  <PersonalTrainer className='svg-img' />
                    ...
                    <motion.h5 animate={controls} variants={textAnimation} transition={{  delay: 0.1, type: "tween" }} >
                        Jestem Trenerem. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quasi corrupti natus vel culpa a id rem quod ex? Fugit neque deleniti incidunt? Accusantium deserunt a omnis porro minus eum sint.
                    </motion.h5>
